...
public class LivroBoundary implements Tela {
	...
	public LivroBoundary(Executor executor) { 
	...
	public void start() {
		...
		Button btnVerAutores = new Button("Ver Autores");
		btnVerAutores.setOnAction(e -> { 
			executor.abrir("autores");
		});
		
		FlowPane painelBotoes = new FlowPane();
		painelBotoes.getChildren().addAll(
				btnSalvar, btnPesquisar, btnVerAutores);
